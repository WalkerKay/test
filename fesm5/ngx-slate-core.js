...
import { __spread, __values, __assign, __extends, __read } from 'tslib';
import { Component, Input, ElementRef, ViewContainerRef, QueryList, HostBinding, Injectable, ComponentFactoryResolver, NgZone, ChangeDetectionStrategy, ChangeDetectorRef, ViewChild, NgModule, ɵɵdefineInjectable, ɵɵinject, EventEmitter, Renderer2, Output, forwardRef, IterableDiffers, ViewChildren } from '@angular/core';
...
var SlaEventService = /** @class */ (function () {
    ...
    SlaEventService.prototype.fromSlaEvents = function (element, $destroy) {
        return merge.apply(void 0, __spread(NGX_SLATE_EVENTS.map(function (eventEntity) {
